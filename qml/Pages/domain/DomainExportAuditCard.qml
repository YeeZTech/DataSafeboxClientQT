...
Card {
    ...
    // never collides with neighbours. The +30 covers CenteredTooltipText's own padding
    ...
    // File-size values are short ("7.16 kb"); keep this column just wide enough for the
    // "File Size" header so the freed width goes to the cramped name columns.
    readonly property int colSize: 62
        ...
        Column {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Item {
                        Layout.preferredWidth: card.colSize
                        Layout.fillHeight: true
                        Text {
                            anchors.left: parent.left
                            anchors.leftMargin: 6
